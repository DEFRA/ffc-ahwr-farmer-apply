...
describe('isUserOldWorldReadyToPayWithinTenMonths', () => {
  test.each([
    { applicationData: [], expected: { isExistingUserRejectedAgreementWithin10months: false, message: 'new user, Offer is not Ready To Pay' } },
    { applicationData: [{ dateOfClaim: 'invalid date' }, { dateOfClaim: 'invalid date' }], expected: { isExistingUserRejectedAgreementWithin10months: false, message: 'new user, Offer is not Ready To Pay' } },
    { applicationData: [{ dateOfClaim: new Date('2021-01-01') }, { dateOfClaim: new Date('2021-01-01') }], expected: { isExistingUserRejectedAgreementWithin10months: false, message: 'new user, Offer is not Ready To Pay' } },
    { applicationData: [{ type: 'VV' }, { type: 'EE' }], expected: { isExistingUserRejectedAgreementWithin10months: false, message: 'Offer is not Ready To Pay' } },
    { applicationData: [{ statusId: 2 }, { statusId: 2 }], expected: { isExistingUserRejectedAgreementWithin10months: false, message: 'new user, Offer is not Ready To Pay' } },
