...
import {
  getPersonName,
  getPersonSummary,
} from "../../../../../app/api-requests/rpa-api/person";
  ...
  test.each([
    {
      ...
      middleName: "James",
      lastName: "Smith",
      expectedResult: "Bill James Smith",
    },
    ...
    },
    {
      ...
      middleName: "",
      lastName: "Smith",
      expectedResult: "Bill Smith",
    },
    { firstName: "", middleName: "", lastName: "", expectedResult: "" },
    { firstName: null, middleName: null, lastName: null, expectedResult: "" },
  ])(
    "when getPersonName called with Firstname=$firstName Middlename=$middleName Lastname=$lastName returns $expectedResult",
    async ({ firstName, middleName, lastName, expectedResult }) => {
      const personSummary = {
        firstName,
        middleName,
        lastName,
