    ...
    get.mockResolvedValueOnce({
      data: {
        ...
        personPrivileges: [
          {
            personId,
            privilegeNames: ["Invalid permission"],
          },
        ],
      },
    });
  ...
  test.each([
    {
      ...
      expectedResult: "1 Test House,Test City,Test County,Test Postcode",
    },
    {
      address1: "1 Test House",
      city: "",
      county: "Test County",
      postalCode: "Test Postcode",
      expectedResult: "1 Test House,Test County,Test Postcode",
    },
    {
      address1: "1 Test House",
      city: "Test City",
      county: "",
      postalCode: "Test Postcode",
      expectedResult: "1 Test House,Test City,Test Postcode",
    },
    {
      address1: "1 Test House",
      city: "Test City",
      county: "Test County",
      postalCode: "",
      expectedResult: "1 Test House,Test City,Test County",
    },
