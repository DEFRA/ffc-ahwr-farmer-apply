...
const schema = Joi.object({
  ...
  serviceName: Joi.string().default(process.env.ENDEMICS_ENABLED === 'true' ? 'Get funding to improve animal health and welfare' : 'Annual health and welfare review of livestock'),
